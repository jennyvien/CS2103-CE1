 ...
 * 
 * If the user does not specify what file s/he would like inputs to get written out to, 
 * program will store it into "mytextfile.txt" by default.
 * 
 * If the user does not enter in a valid command, they will be prompt to enter another command.
 * 
 * @author Jenny Vien
 */
public class TextBuddy {
	...
	public void startProgram() {
		this.printMessage(MSG_WELCOME);
		this.handleUserCommands();
	}
	/**
	 * This method accepts and executes user command until user 
	 * specifies that s/he wants to exit.
	 */
	private void handleUserCommands() {
		while (true) {
			this.printMessage(MSG_ENTER_COMMAND);
	...
	private void executeUserCommands() {
		...
		case "add":
			...
			printMessage(MSG_ADDED_ITEM, commandArgument);
			break;
		case "display":
			this.displayItems();
			break;
		case "delete":
			...
			printMessage(MSG_DELETED_ITEM, deletedItem);
			break;
		case "clear":
			this.clearFileContent();
			printMessage(MSG_CLEARED_CONTENT);
			break;
		case "exit":
			System.exit(0);
		default:
			this.printMessage(MSG_INVALID_COMMAND);
		}
	}
	...
	/**
	 * Helper method that take the input generated by getUserInput() and 
	...
	/**
	 * Helper method that takes the input generated by getUserInput() and 
	...
	private String extractCommandArgument(String[] userInput) {
		...
		// Check to see if the user input has an argument.
	...
	private void displayItems() {
		if (this.numItems == 0) {
			this.printMessage(MSG_NO_ITEMS_TO_DISPLAY);
		} else {
			this.printItems();
		}
	}
	 ...
	 */
	private void printMessage(String feedBackMessage) {
	...
	private void printMessage(String feedBackMessage, String feedbackArg) {
